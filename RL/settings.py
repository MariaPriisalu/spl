...
class run_settings(object):
    ...
    def __init__(self,evaluate=False, name_movie="", env_width=128, env_depth=256, env_height=32, likelihood=False,
        ...
        model ="run_agent__carla_pfnntrain_model_with_car_and_corrected_reward_occluded_2021-09-24-10-24-05.839933/model.ckpt-8"#"run_agent__carla_pfnntrain_car_and_initializer_alternatively_2021-06-10-21-47-22.745677/model.ckpt-7"

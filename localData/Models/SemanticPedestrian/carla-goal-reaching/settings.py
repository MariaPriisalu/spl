...
class run_settings(object):
    ...
    def __init__(self,evaluate=False, name_movie="", env_width=128, env_depth=256, env_height=32, likelihood=False,
        ...
        experiment_name = "goal_reaching_carla_pedestrian"  # Whatever is being tested right now. It is not possible to keep track of runs without giving them distinct names!

        # When running on trained or pretrained weights.
        model ="train_carla_goal_new_reward_pfnn_new_penalty_2020-07-04-23-24-16.893992/"#"run_agent__carla_pfnntrain_car_and_initializer_alternatively_2021-06-10-21-47-22.745677/model.ckpt-7"

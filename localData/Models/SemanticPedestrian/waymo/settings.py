...
class run_settings(object):
    ...
    def __init__(self,evaluate=False, name_movie="", env_width=128, env_depth=256, env_height=32, likelihood=False,
        ...
        experiment_name = "waymo_pedestrian"  # Whatever is being tested right now. It is not possible to keep track of runs without giving them distinct names!

        # When running on trained or pretrained weights.
        model ="agent_waymo_goal_free_pfnn_2020-07-05-15-15-49.541581/"#"run_agent__carla_pfnntrain_car_and_initializer_alternatively_2021-06-10-21-47-22.745677/model.ckpt-7"

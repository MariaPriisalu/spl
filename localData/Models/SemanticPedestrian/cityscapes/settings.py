...
class run_settings(object):
    ...
    def __init__(self,evaluate=False, name_movie="", env_width=128, env_depth=256, env_height=32, likelihood=False,
        ...
        experiment_name = "goal_reaching_cityscapes_pedestrian"  # Whatever is being tested right now. It is not possible to keep track of runs without giving them distinct names!

        # When running on trained or pretrained weights.
        model ="train_cityscapes_pfnn_angular_old_penalty_2020-07-04-17-52-32.011443/"#"run_agent__carla_pfnntrain_car_and_initializer_alternatively_2021-06-10-21-47-22.745677/model.ckpt-7"

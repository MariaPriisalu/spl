...
class run_settings(object):
    ...
    def __init__(self,evaluate=False, name_movie="", env_width=128, env_depth=256, env_height=32, likelihood=False,
        ...
        self.goal_dir=False # Does pedestrian agent have goal?
        ...
        self.reward_weights[PEDESTRIAN_REWARD_INDX.not_on_time_at_goal] =-0.0001  # 0#-0.1#-0.1# -0.0001 # 0.1

        # Penalty for large change in poses
        self.reward_weights[PEDESTRIAN_REWARD_INDX.large_change_in_pose] =-0.0001  # 0#-0.1#-0.1# -0.0001 # 0.1
        ...
        experiment_name = "carla_pedestrian"  # Whatever is being tested right now. It is not possible to keep track of runs without giving them distinct names!

        # When running on trained or pretrained weights.
        model ="train_pfnn_pose_penalized_2020-06-30-22-25-50.394548/model.ckpt-1"#"run_agent__carla_pfnntrain_car_and_initializer_alternatively_2021-06-10-21-47-22.745677/model.ckpt-7"
        ...
        self.train_car_and_initialize = ""  # "simultaneously", "alternatively" ,"according_to_stats" or ""

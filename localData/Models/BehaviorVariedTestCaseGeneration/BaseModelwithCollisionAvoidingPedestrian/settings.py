...
class run_settings(object):
    ...
    def __init__(self,evaluate=False, name_movie="", env_width=128, env_depth=256, env_height=32, likelihood=False,
        ...
        experiment_name = "base_model_unoccluded"  # Whatever is being tested right now. It is not possible to keep track of runs without giving them distinct names!

        # When running on trained or pretrained weights.
        model ="run_agent__carla_pfnntrain_model_with_car_and_corrected_reward_2021-09-15-10-01-32.036798/model.ckpt-6"

...
int RunDenseFuser(int argc, char** argv) {
  ...
  std::string output_path_seg;
  std::string output_path_seg_col;
  ...
  options.AddRequiredOption("output_path", &output_path);
  options.AddRequiredOption("output_path_text", &output_path_text);
  options.AddRequiredOption("output_path_seg", &output_path_seg);
  options.AddRequiredOption("output_path_seg_col", &output_path_seg_col);
  ...
  std::cout << "Writing output: " << output_path_text<< std::endl;
  WritePlyText(output_path_text, fuser.GetFusedPoints());
  std::cout << "Writing output: " << output_path_seg<< std::endl;
  WritePlySegBinary(output_path_seg, fuser.GetFusedPoints());
  std::cout << "Writing output: " << output_path_seg_col<< std::endl;
  WritePlySegBinaryCol(output_path_seg_col, fuser.GetFusedPoints());
  return EXIT_SUCCESS;
}
...
int RunDenseMesher(int argc, char** argv) {
  ...
  options.AddRequiredOption("input_path", &input_path);
  options.AddRequiredOption("output_path", &output_path);
  //options.AddRequiredOption("voxel_path", &voxel_path);

...
HERO_DEFAULT_SCALE_ZOOMED_TO_OBSERVE = 0.1
...
class World(object):
    ...
    def start(self, hud, input_control):
        ...
        if self.args.use_hero_actor:
            ...
            self._input.wheel_offset = HERO_DEFAULT_SCALE_ZOOMED_TO_OBSERVE
    ...
    def render(self, display):
        ...
        if self.hero_actor is not None:
            ...
            if self.frameCounter > 10 and self.initPosDone is False:
                observerPosRatio_X, observerPosRatio_Y = ((self.fixedObserverPos[0] - self.map_image._world_offset[0]) / self.map_image.width,
                                                          (self.fixedObserverPos[1] - self.map_image._world_offset[1]) / self.map_image.width)
                ...
                self._input.pending_ZoomFactor = 0.3
...
class InputControl(object):
    ...
    def _parse_events(self):
        ...
        for event in pygame.event.get():
            ...
            elif self.pending_customZoomAndPos == True or event.type == pygame.MOUSEBUTTONDOWN:
        ...
        if self.pending_customZoomAndPos is True:
            self.pending_customZoomAndPos = False
